...
class Amentities(models.Model):
    amentity = models.CharField(max_length=300, null=True, unique=True)
...
class Workers(models.Model):
    ...
    staff_phoneNumber = models.CharField(max_length=15, null=True, unique=True)
...
class Partners(models.Model):
    partner_name = models.CharField(max_length=200, null=True, unique=True)
...
class Fqa(models.Model):
    ...
    answer = models.CharField(max_length=400, null=True, unique=True)
